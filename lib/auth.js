...
const redirectUser = (res, path) => {
  if (res) {
    ...
    /**
     * res.finished is a next.js construct only,
     * that tells next.js you have handled the entire request/response
     * lifecycle in getInitialProps,
     * so that it knows not to continue writing to the response.
     */
    res.finished = true;
    return {};
  }
